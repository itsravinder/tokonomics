# Downloads the official rtk Windows binary into tokenscope/bin/.
# rtk is licensed Apache-2.0 (https://github.com/rtk-ai/rtk).
$ErrorActionPreference = "Stop"

$root = Split-Path -Parent $PSScriptRoot
$binDir = Join-Path $root "tokenscope\bin"
New-Item -ItemType Directory -Force -Path $binDir | Out-Null

Write-Host "Resolving latest rtk release..."
$rel = Invoke-RestMethod -Uri "https://api.github.com/repos/rtk-ai/rtk/releases/latest" -Headers @{ "User-Agent" = "tokenscope" }
